            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <Link
                        ...
                        aria-label="LinkedIn"
                        className="text-muted-foreground hover:text-[#f84f08] block">
                        <svg
                            className="size-6"
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {2026} Cluster, Todos os direitos reservados.</span>
            </div>
        </footer>
    )
}